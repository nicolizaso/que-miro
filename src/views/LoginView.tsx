  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (err?.code === 'auth/unauthorized-domain' || err?.message?.includes('unauthorized-domain')) {
        setError('El dominio de la aplicación no está autorizado en la consola de Firebase para iniciar sesión con Google. Por favor, ingresa con tu Email y Contraseña o continúa como Invitado.');
      } else {
